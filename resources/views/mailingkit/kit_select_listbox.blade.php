    ...
    <div class="card-body">
        <div class="row">
            <div class="kit_select_box col-sm-12 col-md-3">
                ...
                <div class="row kit_count_row">
                    <div class="col kit_number">
                        ...
                        >
                            @for($i = 0; $i <= 5; $i++)
                                <option value="{{ $i }}" @if($i == old($item_name)) selected @endif>{{ $i }}個</option>
                            @endfor
                        </select>
                    </div>
                </div>
            ...
            <div class="kit_select_box col-sm-12 col-md-3">
                ...
                <div class="row kit_count_row">
                    <div class="col-12 text-center size_text">Mサイズ</div>
                    <div class="col kit_number">
                        @php($kit_size = "m")
                        @php($item_name = "kit_count_".$kit_size)
                        <select
            ...
            <div class="kit_select_box col-sm-12 col-md-3">
                ...
                <div class="row kit_count_row">
                    <div class="col-12 text-center size_text">Lサイズ</div>
                    <div class="col kit_number">
                        @php($kit_size = "l")
                        @php($item_name = "kit_count_".$kit_size)
                        <select
        ...
        @php($item_name = "kit_count_".$kit_size)
            ...
            <div class="kit_select_box col-sm-12 col-md-3">
                ...
                <div class="row kit_count_row">
                    <div class="col-12 text-center size_text">クッション封筒</div>
                    <div class="col kit_number">
                        @php($kit_size = "k")
                        @php($item_name = "kit_count_".$kit_size)
                        <select
