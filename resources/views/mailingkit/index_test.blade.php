@extends('layouts.app')
@section('title')テスト宅配買取お申し込みフォーム@endsection
...
<div class="container-fluid">
  <div class="row justify-content-md-center">
    <div class="col col-md-10 p-0">
            <!-- 年末年始休業バナー -->
      <!-- <div class="sp_none">
        <img src="https://rifa.life/refasta_wordpress/wp-content/uploads/2021/04/スクリーンショット-0003-04-20-10.20.48.png" style="max-width: 100%;
        display: block;
        margin: auto;
        width: 95%;" alt="">
      </div>
                    ...
                    <div class="modal-body">
                      <table id="time_calender_box" class="text-center">
                        ...
                        <tr>
                          ...
                          <td class="day_time_sel" id="<?=$month[5].'/'.$day[5].'('.$wday[5].') '.$sel[1]?>"><?=$basic_four_days_later_all?></td>
                          <td class="day_time_sel" id="<?=$month[6].'/'.$day[6].'('.$wday[6].') '.$sel[1]?>"><?=$basic_five_days_later_all?></td>
                        ...
                        <tr>
                          ...
                          <td class="day_time_sel" id="<?=$month[5].'/'.$day[5].'('.$wday[5].') '.$sel[2]?>"><?=$basic_four_days_later_all?></td>
                          <td class="day_time_sel" id="<?=$month[6].'/'.$day[6].'('.$wday[6].') '.$sel[2]?>"><?=$basic_five_days_later_all?></td>
                        ...
                        <tr>
                          ...
                          <td class="day_time_sel" id="<?=$month[5].'/'.$day[5].'('.$wday[5].') '.$sel[3]?>"><?=$basic_four_days_later_all?></td>
                          <td class="day_time_sel" id="<?=$month[6].'/'.$day[6].'('.$wday[6].') '.$sel[3]?>"><?=$basic_five_days_later_all?></td>
                        ...
                        <tr>
                          ...
                          <td class="day_time_sel" id="<?=$month[5].'/'.$day[5].'('.$wday[5].') '.$sel[4]?>"><?=$basic_four_days_later_all?></td>
                          <td class="day_time_sel" id="<?=$month[6].'/'.$day[6].'('.$wday[6].') '.$sel[4]?>"><?=$basic_five_days_later_all?></td>
                        ...
                        <tr>
                          ...
                          <td class="day_time_sel" id="<?=$month[5].'/'.$day[5].'('.$wday[5].') '.$sel[5]?>"><?=$basic_four_days_later_all?></td>
                          <td class="day_time_sel" id="<?=$month[6].'/'.$day[6].'('.$wday[6].') '.$sel[5]?>"><?=$basic_five_days_later_all?></td>
