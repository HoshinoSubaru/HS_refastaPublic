...
<div class="container-fluid">
  <div class="row justify-content-md-center">
    <div class="col col-md-10 p-0">
      ...
      <!-- <div class = "sp_none">
        <img
        src = "https://kinkaimasu.jp/new/img/holiday/2020_newyear_pc.jpg"
        style="max-width: 100%;
        display: block;
        margin: auto;
        width: 95%;"
      ...
      <div class = "pc_none">
        <img
        src = "https://kinkaimasu.jp/new/img/holiday/2020_newyear_sp.jpg"
        style="max-width: 100%;
        display: block;
        margin: auto;
        width: 95%;"
  ...
  <div class="row justify-content-md-center">
    <div class="col col-md-10 p-0">
      ...
      <form role="form" method="POST" id="delivery_form" action="/delivery_test/thanks" class="needs-validation" novalidate>
        {!! csrf_field() !!}
        <div class="card">
